...
function TeamCard({ member }) {
  return (
    <article className="about-team-card">
      <img src={teamImage.src || teamImage} alt={`${member.name}, ${member.role}`} />
    ...
    <div className="about-page-wrapper">
      ...
      >
        ...
        <div className="about-hero-actions">
          <Link href="/donate" className="about-btn-primary">
            <span>Donate Now</span>
            <span className="about-btn-icon">
              <ArrowRight size={16} />
            </span>
          </Link>
          <Link href="/get-involved/volunteer" className="about-btn-secondary">
      ...
      {/* 2. Our Story Section (Large Brand Card) */}
      <section
      ...
      >
        <div className="about-story-top">
          ...
          <div className="about-story-right">
            ...
            <div className="about-story-cta-row">
              <Link href="/get-involved" className="about-story-btn">
              ...
              <div className="about-founder-snippet">
                <img src={ceoImage.src || ceoImage} alt="Anifowose Temitayo, Founder & CEO" />
                <div>
        ...
        <div className="about-story-bottom">
          <div className="about-story-photo">
            <img
              src={storyTeamImage.src || storyTeamImage}
      ...
      >
        ...
        <div className="about-mission-grid">
          ...
          <div className="about-mission-media">
            <img
              src={missionImage.src || missionImage}

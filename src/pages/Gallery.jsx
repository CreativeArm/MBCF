...
import outreachSmilesImage from "../assets/images/DDB1C07C-626C-4F06-8022-8B6FC46248D8.webp";
import teamMissionImage from "../assets/images/E1F0F196-2A72-40AD-BF82-CB5BA88D77F6.webp";
...
const galleryItems = [
  ...
  },
  {
    ...
    alt: "Care package and essential supplies distribution",
    bentoSlot: 2,
  },
  {
    id: 11,
    title: "Warm Community Togetherness",
    category: "Children",
    location: "Community Visit",
    image: communityJoyImage,
    alt: "Community members gathered together in warmth",
    bentoSlot: 3,
  },
  {
    id: 12,
    title: "Birthday Joy & Cheers",
    category: "Celebration",
    location: "Birthday Celebration",
    image: birthdayKidsImage,
    alt: "Birthday celebration and special moments for kids",
    bentoSlot: 4,
  },
  {
    id: 13,
    title: "Giving Back with Love",
    category: "Outreach",
    location: "Gifts Sharing",
    image: giftShareImage,
    alt: "Gift sharing and happiness during community visit",
    bentoSlot: 5,
  },
  {
    id: 14,
    title: "Hearts of Gratitude",
    category: "Volunteers",
    location: "Outreach Mission",
    image: warmSmilesImage,
    alt: "Warm smiles and gratitude from local families",
    bentoSlot: 6,
  },
  {
    id: 15,
    title: "Direct Support Outreach",
    category: "Food Care",
    location: "Field Refreshment",
    image: supportVisitImage,
    alt: "Volunteer sharing refreshments with children",
    bentoSlot: 0,
  },
  {
    id: 16,
...
function Gallery() {
  ...
  return (
    <div className="gallery-page">
      ...
      {/* Modal Lightbox Pop-up — Pure Centered Image */}

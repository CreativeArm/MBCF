  ...
  return (
    <article className="home-image-card project-card">
      <div className="home-card-image proj-card-media">
        <img src={image || heroImg} alt={title} loading="lazy" />
      ...
      <div className="home-card-body proj-card-body">
        ...
        <Link to={`/projects/${id}`} className="home-card-link proj-card-btn">
...
function Projects() {
  ...
  return (
    <div className="proj-page" ref={pageRef}>
      ...
      {/* ── 3. Featured Spotlight Project (Shown when on All view) ───────── */}
      {showSpotlight && (
